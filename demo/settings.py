...
INSTALLED_APPS = [
    ...
    "demo.catalog",  # This object was created for us in /catalog/apps.py
]
...
# https://docs.djangoproject.com/en/3.1/howto/static-files/ The absolute
# path to the directory where collectstatic will collect static files
# for deployment.
